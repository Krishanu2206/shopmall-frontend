...
function CreateProduct() {
  ...
  return (
    ...
    <div className='row'>
        ...
        <form className='needs-validation' noValidate encType='multipart/form-data' onSubmit={handlecreateform}>
        ...
        <div className='mb-3'>
          {photo && (
            <div className='text-center'>
              <img src={URL.createObjectURL(photo)} alt="Product photo" height={"150px"} width={"150px"} className='img img-responsive'/>
            </div>
          )}
        </div>
        ...
        <button type="submit" className="btn btn-primary register-btn">Create Product</button>
