  ...
  return (
    <Layout>
      {isformsubmitted && (
        ...
        <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close" onClick={(e)=>{
          setisformsubmitted(false)
        }}></button>
        </div>
      )}
      ...
      <div className="contact-form">
        ...
        <form ref={formRef}className="needs-validation" noValidate>
          <div className="mb-2">
            <label htmlFor="contact-form-name" className="form-label">Full name</label>
          ...
          <div className="mb-2">
            <label htmlFor="contact-form-email" className="form-label">Email Address</label>
          ...
          <div className="mb-2">
            <label htmlFor="contactform-subject" className="form-label">Subject</label>
      ...
      <div className="contact-info">
        ...
        <FaPhoneAlt style={{fontSize:"20px"}}/><br/>
        <strong>+91 1234567890</strong>
        </div>
        <div className="contact-info-tollfree">
        <FaHeadphonesAlt style={{fontSize:"20px"}}/><br/>
        <strong>1800-000-000</strong>
        </div>
        <div className="contact-info-email">
        <MdEmail style={{fontSize:"20px"}}/><br/>
        <strong>assailantshopmall123@gmail.com</strong>
        </div>
      </div>
